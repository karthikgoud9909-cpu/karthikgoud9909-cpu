# Varda Karthik Goud — Full Stack Developer / Software Engineer

Email: karthikgoud9909@gmail.com
Location: Medchal, Telangana, India
GitHub: https://github.com/karthikgoud9909-cpu

---

PROFESSIONAL SUMMARY

Results-driven Full Stack Developer and Software Engineer with expertise in building scalable, secure, and maintainable web and enterprise applications. Strong hands-on experience with MERN stack and Java Spring Boot ecosystems, RESTful API design, database schema design and optimization, and system design fundamentals. Proven ability to deliver production-ready services, collaborate in Agile teams, and translate product requirements into reliable solutions.
...
- DevOps & Tools: Git, GitHub, Docker (learning), AWS (basic), CI/CD concepts
- Other: JPA / Hibernate, Unit & Integration Testing, Postman
